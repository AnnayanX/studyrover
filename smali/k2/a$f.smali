...
.method public constructor <init>(Landroid/support/v4/media/session/MediaControllerCompat;Ljava/lang/String;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lk2/a$f;->a:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 11
    :goto_0
    iput-object p2, p0, Lk2/a$f;->b:Ljava/lang/String;
...
.method public synthetic a(Landroid/support/v4/media/MediaMetadataCompat;Landroid/support/v4/media/MediaMetadataCompat;)Z
    ...
    invoke-static {p0, p1, p2}, Lk2/b;->a(Lk2/a$h;Landroid/support/v4/media/MediaMetadataCompat;Landroid/support/v4/media/MediaMetadataCompat;)Z
...
.method public b(Le2/t2;)Landroid/support/v4/media/MediaMetadataCompat;
    .locals 8
    ...
    .line 10
    .line 11
    invoke-static {}, Lk2/a;->a()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    .line 41
    .line 42
    invoke-interface {p1}, Le2/t2;->getDuration()J
    ...
    .line 66
    .line 67
    iget-object p1, p0, Lk2/a$f;->a:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 82
    .line 83
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaControllerCompat;->c()Ljava/util/List;
    ...
    .line 114
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->d()Landroid/os/Bundle;
    ...
    .line 147
    .line 148
    iget-object v5, p0, Lk2/a$f;->b:Ljava/lang/String;
    ...
    .line 372
    :cond_10
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->n()Ljava/lang/CharSequence;
    ...
    .line 392
    :cond_11
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->m()Ljava/lang/CharSequence;
    ...
    .line 407
    :cond_12
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->c()Ljava/lang/CharSequence;
    ...
    .line 422
    :cond_13
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->e()Landroid/graphics/Bitmap;
    ...
    .line 433
    :cond_14
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->f()Landroid/net/Uri;
    ...
    .line 459
    :cond_16
    invoke-virtual {p1}, Landroid/support/v4/media/MediaDescriptionCompat;->k()Landroid/net/Uri;
