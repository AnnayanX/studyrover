...
.field f:Landroid/support/v4/media/session/MediaSessionCompat$b$a;
...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->b:Ljava/lang/Object;
    ...
    .line 15
    .line 16
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->c:Landroid/media/session/MediaSession$Callback;
    ...
    .line 23
    .line 24
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->e:Ljava/lang/ref/WeakReference;
...
.method B(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 8

    .line 1
    iget-boolean v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Z
    ...
    .line 60
    .line 61
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->W()V
    ...
    .line 68
    .line 69
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->Y()V
...
.method E0(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 3

    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->b:Ljava/lang/Object;
    ...
    .line 8
    .line 9
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->e:Ljava/lang/ref/WeakReference;

    .line 10
    .line 11
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$b$a;
    ...
    :cond_2
    :goto_0
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$b$a;
...
.method public Q(Landroid/content/Intent;)Z
    ...
    .line 12
    :try_start_0
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->e:Ljava/lang/ref/WeakReference;
    ...
    .line 19
    .line 20
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$b$a;
    ...
    .line 45
    :cond_2
    invoke-interface {v2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->l()Lh0/a;
    ...
    .line 60
    .line 61
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$b;->B(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    .line 71
    .line 72
    iget-boolean p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Z
    ...
    .line 78
    .line 79
    iput-boolean v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Z
    ...
    .line 101
    .line 102
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->A0()V
    ...
    .line 106
    :cond_5
    iput-boolean v4, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Z
